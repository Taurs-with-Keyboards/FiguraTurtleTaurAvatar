...
local turtleArmor = require("lib.KattArmor")()
...
turtleArmor.Armor.Leggings:setLayer(1)

-- Armor parts
turtleArmor.Armor.Leggings
...
-- Leather armor
turtleArmor.Materials.leather
	:setTexture(textures["textures.armor.leatherArmor"] or textures["Turtle.leatherArmor"])
	:addParts(turtleArmor.Armor.Leggings, table.unpack(parts:createTable(function(part) return part:getName() == "LeggingsLeather" end)))
	:addParts(turtleArmor.Armor.Boots,    table.unpack(parts:createTable(function(part) return part:getName() == "BootLeather" end)))

-- Chainmail armor
turtleArmor.Materials.chainmail
	:setTexture(textures["textures.armor.chainmailArmor"] or textures["Turtle.chainmailArmor"])

-- Iron armor
turtleArmor.Materials.iron
	:setTexture(textures["textures.armor.ironArmor"] or textures["Turtle.ironArmor"])

-- Golden armor
turtleArmor.Materials.golden
	:setTexture(textures["textures.armor.goldenArmor"] or textures["Turtle.goldenArmor"])

-- Diamond armor
turtleArmor.Materials.diamond
	:setTexture(textures["textures.armor.diamondArmor"] or textures["Turtle.diamondArmor"])

-- Netherite armor
turtleArmor.Materials.netherite
	:setTexture(textures["textures.armor.netheriteArmor"] or textures["Turtle.netheriteArmor"])
...
for _, trim in ipairs(trims) do
	local tex = textures["textures.armor.trims."..trim.."Trim"] or textures["Turtle."..trim.."Trim"] or false
	if tex then
		turtleArmor.TrimPatterns[trim]:setTexture(tex)
	end
end
...
acts.armorLeggingsAct = armorPage:newAction()
	:item("iron_leggings")
